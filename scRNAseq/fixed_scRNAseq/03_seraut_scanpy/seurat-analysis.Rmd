...
save(seurat.list, file = "Robjects/scRNA_SeuratObj_List_Sundar10X.RData") # saving list of seurat objects
```
...
```{r metrics}
load("RObjects/scRNA_SeuratObj_Merged_Sundar10X_Metadata.RData")
...
save(filtered_seurat, file = "RObjects/scRNA_SeuratObj_Merged_Sundar10X_CellFiltered.RData")
```

### Gene-level

```{r gene-filt, eval = F}
load(file = "RObjects/scRNA_SeuratObj_Merged_Sundar10X_CellFiltered.RData")
...
save(filtered_seurat, file = "RObjects/scRNA_SeuratObj_Merged_Sundar10X_CellGeneFiltered.RData")
```
...
load("RObjects/scRNA_SeuratObj_Merged_Sundar10X_CellGeneFiltered.RData")
...
save(int.obj, file = "Output/scRNA_Sundar10X_SeuratObj_LogNorm_RPCAIntegrated_v4.RData")
...
int.obj
save(int.obj, file = "Output/scRNA_Sundar10X_SeuratObj_LogNorm_RPCAIntegrated_Clustered.RData")
```
...
load("RObjects/scRNA_SeuratObj_Merged_Sundar071524_CellGeneFiltered.RData")
seu.list = SplitObject(filtered_seurat, split.by = "orig.ident")
...
save(int.obj, file = "Output/scRNA_Sundar071524_SeuratObj_SCT_RPCAIntegrated_v4.RData")
...
int.obj = FindClusters(int.obj, resolution = 1, cluster.name = "rpca_clusters_res1.0")
int.obj
save(int.obj, file = "Output/scRNA_Sundar071524_SeuratObj_SCT_RPCAIntegrated_Clustered.RData")
```
...
```{r}
png(file = "Output/scRNA_Sundar10X_LogNorm_IntegratedRPCA_OrigIdent_PC30.png", width = 800, height = 800)
...
png(file = "Output/scRNA_Sundar10X_LogNorm_IntegratedRPCA_Clusters_PC30.png", width = 800, height = 800)
...
png(file = "Output/scRNA_Sundar10X_LogNorm_IntegratedRPCA_OrigIdent_PC30-clusters.png", width = 3000, height = 800)
...
load("Output/scRNA_Sundar071524_SeuratObj_LogNorm_RPCAIntegrated_Clustered_Predictions.RData")
